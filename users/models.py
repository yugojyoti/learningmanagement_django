...
class Grade(models.Model):
    ...
    unit_test1=models.CharField(max_length=200, blank=True)
    unit_test2=models.CharField(max_length=200, blank=True)
    unit_test3=models.CharField(max_length=200, blank=True)
...
class Answer(models.Model):
    ...
    answer_field=models.CharField(max_length=2000, null=True, blank=True)
